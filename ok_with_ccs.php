...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
        ...
        <h2>Explanation:</h2>
        <p>In this page you are trying to request ``<?php echo $request; ?>'' to the local service. Unfortunately it can't give you the permission you require on its own so it has to contact ``a''. ``a'' contains the appropriate policy and forwards it to the local service that finally authorizes you.</p>
